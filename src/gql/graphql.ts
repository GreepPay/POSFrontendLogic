...
export enum QueryGetBusinessDeliveriesOrderByColumn {
  CreatedAt = 'CREATED_AT',
  UpdatedAt = 'UPDATED_AT'
}

/** Order by clause for Query.GetBusinessDeliveries.orderBy. */
export type QueryGetBusinessDeliveriesOrderByOrderByClause = {
  /** The column that is used for ordering. */
  column: QueryGetBusinessDeliveriesOrderByColumn;
  /** The direction that is used for ordering. */
  order: SortOrder;
};

/** Allowed column names for Query.GetBusinessDeliveries.where. */
export enum QueryGetBusinessDeliveriesWhereColumn {
  CreatedAt = 'CREATED_AT',
...
/** Dynamic WHERE conditions for the `where` argument of the query `GetBusinessDeliveries`. */
export type QueryGetBusinessDeliveriesWhereWhereConditions = {
  /** A set of conditions that requires all conditions to match. */
  AND?: InputMaybe<Array<QueryGetBusinessDeliveriesWhereWhereConditions>>;
  /** Check whether a relation exists. Extra conditions or a minimum amount can be applied. */
  HAS?: InputMaybe<QueryGetBusinessDeliveriesWhereWhereConditionsRelation>;
  /** A set of conditions that requires at least one condition to match. */
  OR?: InputMaybe<Array<QueryGetBusinessDeliveriesWhereWhereConditions>>;
  /** The column that is used for the condition. */
  column?: InputMaybe<QueryGetBusinessDeliveriesWhereColumn>;
...
/** Dynamic HAS conditions for WHERE conditions for the `where` argument of the query `GetBusinessDeliveries`. */
export type QueryGetBusinessDeliveriesWhereWhereConditionsRelation = {
  /** The amount to test. */
